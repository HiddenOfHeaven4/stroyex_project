...
export default class Contact extends React.Component {
  ...
  urlApi = "https://api.stroyexpert.tech";
      ...
      <section id="Contact" className="bg-companyBlue-100">
        <div className="container py-20">
          <div className="bg-white p-10 max-w-lg mx-auto shadow-lg shadow-gray-400/30">
            <p className="text-companyBlue-600 text-3xl font-medium text-center">Связаться с нами</p>
            {this.state.isValidationCheck !== true ?
              <div>
                <div className="">
                  {this.state.isValidationCheck === false ?
                    <div className="bg-errorRed-100 border-l-4 border-errorRed-200 text-errorRed-200 p-4 my-4" role="alert">
                      ...
                      <p>Пожалуйста укажите корректный email.</p>
                    </div>
                    : ''
                  }
                </div>
                <div className="mt-5 mb-3">
                  <input
                    ...
                    name="name" placeholder="Имя" value={this.state.postData.name} onChange={this.handlerChangePostData} />
                </div>
                <div className="mb-3">
                  <input
                    className="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded "
                ...
                <div className="mb-3">
                  <textarea
                    ...
                    name="message" placeholder="Сообщение" rows={14} value={this.state.postData.message} onChange={this.handlerChangePostData} />
                </div>
              ...
              <div className="flex flex-row items-center bg-companyBlue-600 text-white text-sm font-bold px-4 py-3 my-4" role="alert">
                ...
                <p className="grow">Сообщение отправлено</p>
              </div>
            }
          </div>
        </div>
